...
{
//return $items . '<li><a href="/test">Lucreaza</a></li>';
$cart_link = '';
...
$cart_link = '<li><a class="cart-contents" href="' . WC()->cart->get_cart_url() . '">';

 if ( $count > 0 ) {
  $cart_link .= '<span class="cart-contents-count">' . esc_html( $count ) . ' item</span>';
 }
$cart_link .= '</a></li>';
}
